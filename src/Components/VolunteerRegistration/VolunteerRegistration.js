...
const VolunteerRegistration = () => {
  ...
  useEffect(() => {
    fetch("https://hidden-eyrie-83298.herokuapp.com/organizations/" + id)
      .then((res) => res.json())
      .then((data) => {
        const newUser = { ...user };
  ...
  const handleSubmit = (e) => {
    fetch("https://hidden-eyrie-83298.herokuapp.com/addEvents", {
      method: "POST",
      ...
      <div className="text-center mt-4">
        <Link to="/home">
          <img
            ...
            src="https://i.ibb.co/9nJfMcV/Group-1329.png"
            alt=""
          />
        </Link>
      </div>
